<?php
	...
	<div class="rtwcpiglw_tab_div">
		<?php woocommerce_admin_fields(rtwcpiglw_credit_note_css_settings()); ?> 
	</div>
...
* @since    1.0.0
*/
function rtwcpiglw_credit_note_css_settings()
{
...
$settings =	array(
	...
	array(
		'id'          => 'rtwcpiglw_credit_note_page_orien',
		'option_key'  => 'rtwcpiglw_credit_note_page_orien',
		'name'       => esc_html__( 'PDF Page Orientation', 'rtwcpiglw-pdf-invoice-generator-lite-for-woocommerce' ),
		'desc' => esc_html__( 'Choose your required page Orientation for PDF.', 'rtwcpiglw-pdf-invoice-generator-lite-for-woocommerce.' ),
		'type'        => 'select',
		'options'     => array(
			'P'   => esc_html__( 'Portrait', 'rtwcpiglw-pdf-invoice-generator-lite-for-woocommerce' ),
			'L'  => esc_html__( 'Landscape', 'rtwcpiglw-pdf-invoice-generator-lite-for-woocommerce' )
		),
		'desc_tip' =>  true,
	),
	array(
		'name' 		=> esc_html__( 'Body Top Margin', 'rtwcpiglw-pdf-invoice-generator-lite-for-woocommerce' ),
		'type' 		=> 'number',
		'desc' 		=> esc_html__( 'Enter your required top margin for main pdf body (By default 37). Minimum 37 required otherwise will not work.', 'rtwcpiglw-pdf-invoice-generator-lite-for-woocommerce' ),
		'id'   		=> 'rtwcpiglw_credit_note_body_top_margin',
		'default'	=> '37',
		'desc_tip' =>  true,
	),
	array(
		'name' 		=> esc_html__( 'Body Left Margin', 'rtwcpiglw-pdf-invoice-generator-lite-for-woocommerce' ),
		'type' 		=> 'number',
		'desc' 		=> esc_html__( 'Enter your required left margin for main pdf body (By default 15)', 'rtwcpiglw-pdf-invoice-generator-lite-for-woocommerce' ),
		'id'   		=> 'rtwcpiglw_credit_note_body_left_margin',
		'default'	=> '15',
		'desc_tip' =>  true,
	),
	array(
		'name' 		=> esc_html__( 'Body Right Margin', 'rtwcpiglw-pdf-invoice-generator-lite-for-woocommerce' ),
		'type' 		=> 'number',
		'desc' 		=> esc_html__( 'Enter your required right margin for main pdf body (By default 15)', 'rtwcpiglw-pdf-invoice-generator-lite-for-woocommerce' ),
		'id'   		=> 'rtwcpiglw_credit_note_body_right_margin',
		'default'	=> '15',
		'desc_tip' =>  true,
	),
	array(
		'name' 		=> esc_html__( 'Body Font Size', 'rtwcpiglw-pdf-invoice-generator-lite-for-woocommerce' ),
		'type' 		=> 'number',
		'desc' 		=> esc_html__( 'Enter your required font size for Body of the Pdf(By default 15).', 'rtwcpiglw-pdf-invoice-generator-lite-for-woocommerce' ),
		'id'   		=> 'rtwcpiglw_credit_note_body_font_size',
		'default'	=> '15',
		'desc_tip' =>  true,
	),
	array(
		'name' 		=> esc_html__( 'PDF Custom CSS', 'rtwcpiglw-pdf-invoice-generator-lite-for-woocommerce' ),
		'type' 		=> 'textarea',
		'desc' 		=> esc_html__( 'Enter your required custom css for PDF.', 'rtwcpiglw-pdf-invoice-generator-lite-for-woocommerce' ),
		'id'   		=> 'rtwcpiglw_credit_note_pdf_css',
		'desc_tip' =>  true,
	),
	array(
		'id'          => 'rtwcpiglw_credit_note_body_font_family',
		'option_key'  => 'rtwcpiglw_credit_note_body_font_family',
		'name'       => esc_html__( 'Body Font Family', 'rtwcpiglw-pdf-invoice-generator-lite-for-woocommerce' ),
		'desc' => esc_html__( 'Select Font type for Body section text.', 'rtwcpiglw-pdf-invoice-generator-lite-for-woocommerce' ),
		'type'        => 'select',
	...
	'section_end' => array(
		'type' => 'sectionend',
		'id' => 'rtwcpiglw_credit_note_css_setting_opt'
	)
);
