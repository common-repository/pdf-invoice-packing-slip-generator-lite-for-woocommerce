<?php
	...
	if(isset(($_POST['rtwcpiglw_submit']))) {
		...
		<div class="notice notice-success is-dismissible">
			...
			update_option( 'rtwcpiglw_shpng_lable_footer_setting_opt', sanitize_post($_POST['rtwcpiglw_shpng_lable_footer_setting_opt']) );

			woocommerce_update_options( rtwcpiglw_shpng_lable_footer_settings());
		}

		settings_fields('rtwcpiglw_footer_setting');
		$rtwcpiglw_get_setting = get_option('rtwcpiglw_shpng_lable_footer_setting_opt', array());

	?>

	<div class="rtwcpiglw_tab_div">
		<?php woocommerce_admin_fields(rtwcpiglw_shpng_lable_footer_settings()); ?> 
	</div>
			...
			<tr>
				...
				<td>
					...
					$rtwcpiglw_setting = array(
						'wpautop' => true,
						'media_buttons' => true,
						'textarea_name' => 'rtwcpiglw_shpng_lable_footer_setting_opt[rtw_footer_html]',
						'textarea_rows' => 7
					);
...
* @since    1.0.0
*/
function rtwcpiglw_shpng_lable_footer_settings()
{
...
$settings =	array(
	'section_title' => array(
		...
		'type'     => 'title',
		'desc'     => '',
		'id'       => 'rtwcpiglw_shpng_lbl_footer_setting_optn'
	),
	array(
		...
		'id'   		=> 'rtwcpiglw_shpng_lbl_footer_top_margin',
		'default'   => '15',
		'desc_tip' =>  true,
	),
	array(
		...
		'id'   		=> 'rtwcpiglw_shpng_lbl_footer_font_size',
		'default'   => '15',
		'desc_tip' =>  true,
	),
	array(
		'id'          => 'rtwcpiglw_shpng_lbl_footer_font_family',
		'option_key'  => 'rtwcpiglw_shpng_lbl_footer_font_family',
