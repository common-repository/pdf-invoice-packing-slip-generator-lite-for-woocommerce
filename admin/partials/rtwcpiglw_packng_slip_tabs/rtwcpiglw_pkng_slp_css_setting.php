...
{
	$rtwcpiglw_pkngslp_font_array[$rtwcpiglw_key] = $rtwcpiglw_value ;
}
if(isset(($_POST['rtwcpiglw_submit']))){
	...
	update_option( 'rtwcpiglw_pckngslp_css_setting_opt', sanitize_post( $_POST['rtwcpiglw_pckngslp_css_setting_opt'] ) );
}

$rtwcpiglw_get_setting =  get_option('rtwcpiglw_pckngslp_css_setting_opt');

$rtwcpiglw_pdf_page_size = array (
...
<table class="wp-list-table form-table rtw-table">
	<tbody>
		<tr>
			<th class="descr"><?php esc_html_e('PDF Page Orientation', 'rtwcpiglw-pdf-invoice-generator-lite-for-woocommerce');?></th>
			<td class="descr_2">
				<select name="rtwcpiglw_pckngslp_css_setting_opt[rtwcpiglw_pckngslp_page_orien]">
					<option value="P" <?php echo isset( $rtwcpiglw_get_setting['rtwcpiglw_pckngslp_page_orien'] ) && $rtwcpiglw_get_setting['rtwcpiglw_pckngslp_page_orien'] == 'P' ? esc_html('selected="selected"') : '';?>><?php esc_html_e('Portrait', 'rtwcpiglw-pdf-invoice-generator-lite-for-woocommerce');?>
				</option>
				<option value="L" <?php echo isset( $rtwcpiglw_get_setting['rtwcpiglw_pckngslp_page_orien'] ) && $rtwcpiglw_get_setting['rtwcpiglw_pckngslp_page_orien'] == 'L' ? esc_html('selected="selected"') : '';?>><?php esc_html_e('Landscape', 'rtwcpiglw-pdf-invoice-generator-lite-for-woocommerce');?>
			</option>
		</select>
		<div><?php esc_html_e('Select The Orientation of the PDF.', 'rtwcpiglw-pdf-invoice-generator-lite-for-woocommerce');?></div>
	</td>
</tr>
<tr>
	<th><?php esc_html_e('PDF Page Size', 'rtwcpiglw-pdf-invoice-generator-lite-for-woocommerce');?></th>
	<td class="descr_2">
		<select name="rtwcpiglw_pckngslp_css_setting_opt[rtwcpiglw_pdf_page_size]">
			<option><?php esc_html_e('Select', 'rtwcpiglw-pdf-invoice-generator-lite-for-woocommerce'); ?></option>
			<?php
			foreach ($rtwcpiglw_pdf_page_size as $rtwcpiglw_key => $rtwcpiglw_value) 
			{
				?>
				<option value="<?php echo esc_attr($rtwcpiglw_value);?>" <?php echo esc_html(isset( $rtwcpiglw_get_setting['rtwcpiglw_pdf_page_size'] )) && $rtwcpiglw_get_setting['rtwcpiglw_pdf_page_size'] == $rtwcpiglw_value ? 'selected="selected"' : '';?>><?php echo esc_html($rtwcpiglw_key);?></option>
				<?php
			}
			?>
		</select>
		<div class="descr"><?php esc_html_e('Choose the size of Pdf page.', 'rtwcpiglw-pdf-invoice-generator-lite-for-woocommerce');?></div>
	</td>
</tr>
<tr>
	<th class="descr"><?php esc_html_e('Body Top Margin', 'rtwcpiglw-pdf-invoice-generator-lite-for-woocommerce');?></th>
	<td class="descr_2">
		<input type="number" name="rtwcpiglw_pckngslp_css_setting_opt[rtwcpiglw_pckngslp_body_top_margin]" value="<?php echo esc_attr( isset ( $rtwcpiglw_get_setting['rtwcpiglw_pckngslp_body_top_margin'] ) ? $rtwcpiglw_get_setting['rtwcpiglw_pckngslp_body_top_margin'] : ''); ?>">
		<div class="descr"><?php esc_html_e('Enter your required top margin for main pdf body (By default 37). Minimum 37 required otherwise will not work.', 'rtwcpiglw-pdf-invoice-generator-lite-for-woocommerce');?></div>
	</td>
</tr>
<tr>
	<th class="descr"><?php esc_html_e('Body Left Margin', 'rtwcpiglw-pdf-invoice-generator-lite-for-woocommerce');?></th>
	<td class="descr_2">
		<input type="number" name="rtwcpiglw_pckngslp_css_setting_opt[rtwcpiglw_pckngslp_body_left_margin]" value="<?php echo esc_attr( isset ( $rtwcpiglw_get_setting['rtwcpiglw_pckngslp_body_left_margin'] ) ? $rtwcpiglw_get_setting['rtwcpiglw_pckngslp_body_left_margin'] : ''); ?>">
		<div class="descr"><?php esc_html_e('Enter your required left margin for main pdf body (By default 15).', 'rtwcpiglw-pdf-invoice-generator-lite-for-woocommerce');?></div>
	</td>
</tr>
<tr>
	<th class="descr"><?php esc_html_e('Body Right Margin', 'rtwcpiglw-pdf-invoice-generator-lite-for-woocommerce');?></th>
	<td class="descr_2">
		<input type="number" name="rtwcpiglw_pckngslp_css_setting_opt[rtwcpiglw_pckngslp_body_right_margin]" value="<?php echo esc_attr( isset ( $rtwcpiglw_get_setting['rtwcpiglw_pckngslp_body_right_margin'] ) ? $rtwcpiglw_get_setting['rtwcpiglw_pckngslp_body_right_margin'] : ''); ?>">
		<div class="descr"><?php esc_html_e('Enter your required right margin for main pdf body (By default 15).', 'rtwcpiglw-pdf-invoice-generator-lite-for-woocommerce');?></div>
	</td>
</tr>
<tr>
	<th class="descr"><?php esc_html_e('Body Font Size', 'rtwcpiglw-pdf-invoice-generator-lite-for-woocommerce');?></th>
	<td class="descr_2">
		<input type="number" name="rtwcpiglw_pckngslp_css_setting_opt[rtwcpiglw_pckngslp_body_font_size]" value="<?php echo esc_attr( isset ( $rtwcpiglw_get_setting['rtwcpiglw_pckngslp_body_font_size'] ) ? $rtwcpiglw_get_setting['rtwcpiglw_pckngslp_body_font_size'] : ''); ?>">
		<div class="descr"><?php esc_html_e('Enter your required font size for Body of the Pdf(By default 15).', 'rtwcpiglw-pdf-invoice-generator-lite-for-woocommerce');?></div>
	</td>
</tr>
<tr>
	<th class="descr"><span class="rtwcpiglw_pro_image"><img src="<?php echo esc_url( RTWCPIGLW_URL.'assets/pro.png' ); ?>" alt="pro_feature"></span><span class="rtwcpiglw_pro_text"><?php esc_html_e('Pdf Custom CSS', 'rtwcpiglw-pdf-invoice-generator-lite-for-woocommerce');?></span></th>
	<td class="descr">
		<textarea rows="8" cols="50"><?php echo esc_html(isset( $rtwcpiglw_get_setting['rtwcpiglw_pckngslp_pdf_css'] )) ? $rtwcpiglw_get_setting['rtwcpiglw_pckngslp_pdf_css'] : ''; ?></textarea>
...
<tr>
	<th class="descr"><?php esc_html_e('Body Font Family', 'rtwcpiglw-pdf-invoice-generator-lite-for-woocommerce');?></th>
	<td class="descr_2">
		<select name="rtwcpiglw_pckngslp_css_setting_opt[rtwcpiglw_pckngslp_body_font_family]">
			<?php 
			foreach ( $rtwcpiglw_pkngslp_font_array as $rtwcpiglw_key => $rtwcpiglw_value ) 
			{ 
				?>
				<option value="<?php echo esc_attr($rtwcpiglw_value);?>" <?php echo isset( $rtwcpiglw_get_setting['rtwcpiglw_pckngslp_body_font_family'] ) && $rtwcpiglw_get_setting['rtwcpiglw_pckngslp_body_font_family'] == $rtwcpiglw_value ? esc_html('selected="selected"') : '';?>><?php echo esc_html($rtwcpiglw_key);?></option>
				<?php
			}
			?>
		</select>
