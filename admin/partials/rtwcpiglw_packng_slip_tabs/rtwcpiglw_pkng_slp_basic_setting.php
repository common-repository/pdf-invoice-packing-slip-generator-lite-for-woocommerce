	...
	<table class="wp-list-table form-table rtw-table">
		<tbody>
			<tr>
				...
				<td class="descr_2">
					<input type="checkbox" name="rtwcpiglw_pkngslp_basic_stng_opt[rtwcpiglw_enable_pkng_slp]" value="1" <?php  if(isset($rtwcpiglw_get_setting['rtwcpiglw_enable_pkng_slp']) && $rtwcpiglw_get_setting['rtwcpiglw_enable_pkng_slp']==1){ echo 'checked=checked';} ?>/>
			...
			<tr>
				...
				<td class="descr_2">
					<input type="checkbox" name="rtwcpiglw_pkngslp_basic_stng_opt[rtwcpiglw_download_pkng_slp]" value="1" <?php if(isset($rtwcpiglw_get_setting['rtwcpiglw_download_pkng_slp']) && $rtwcpiglw_get_setting['rtwcpiglw_download_pkng_slp']==1){ echo 'checked=checked';} ?>  />
			...
			<tr>
				...
				<td class="descr_2">
					<input type="checkbox" name="rtwcpiglw_pkngslp_basic_stng_opt[rtwcpiglw_pkng_slp_page_no]" value="1" <?php if(isset($rtwcpiglw_get_setting['rtwcpiglw_pkng_slp_page_no']) && $rtwcpiglw_get_setting['rtwcpiglw_pkng_slp_page_no']==1){ echo 'checked=checked';} ?> />
