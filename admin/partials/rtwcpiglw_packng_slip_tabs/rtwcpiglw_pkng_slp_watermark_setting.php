...
if(isset(($_POST['rtwcpiglw_submit']))) { ?>
	...
	update_option( 'rtwcpiglw_pckngslp_watermark_setting_opt', sanitize_post($_POST['rtwcpiglw_pckngslp_watermark_setting_opt']) );

}
$rtwcpiglw_get_setting = get_option('rtwcpiglw_pckngslp_watermark_setting_opt'); 

$rtwcpiglw_wtrmrk_txt = get_option('rtwcpiglw_enable_pckngslp_text_watermark');
$rtwcpiglw_wtrmrk_img = get_option('rtwcpiglw_enable_pckngslp_image_watermark');
$rtwcpiglw_wtrmrk_img_dim = get_option('rtwcpiglw_pckngslp_watermark_img_dim');
$rtwcpiglw_wtrmrk_img_pos = get_option('rtwcpiglw_pckngslp_watermark_img_pos');

?>

<input type="hidden" id="pckngslp_show_wtrmrk_txt" value="<?php echo esc_attr($rtwcpiglw_wtrmrk_txt); ?>">
<input type="hidden" id="pckngslp_show_wtrmrk_img" value="<?php echo esc_attr($rtwcpiglw_wtrmrk_img); ?>">
<input type="hidden" id="pckngslp_wtrmrk_img_dim" value="<?php echo esc_attr($rtwcpiglw_wtrmrk_img_dim); ?>">
<input type="hidden" id="pckngslp_wtrmrk_img_pos" value="<?php echo esc_attr($rtwcpiglw_wtrmrk_img_pos); ?>">
<!-- Image watermark -->
<table class="wp-list-table form-table rtw-table">
	<tr>
		...
		<td class="descr_2">
			...
			name="rtwcpiglw_pckngslp_watermark_setting_opt[rtwcpiglw_enable_pckngslp_text_watermark]" value='1' 
			<?php if(isset( $rtwcpiglw_get_setting['rtwcpiglw_enable_pckngslp_text_watermark']) && $rtwcpiglw_get_setting['rtwcpiglw_enable_pckngslp_text_watermark']=='1' ){echo 'checked=checked';} ?> />
	...
	<tr>
		...
		<td class="descr_2">
			<textarea name="rtwcpiglw_pckngslp_watermark_setting_opt[rtwcpiglw_watermark_text]" rows="4" cols="35"><?php if( isset($rtwcpiglw_get_setting['rtwcpiglw_watermark_text'])) { echo esc_html($rtwcpiglw_get_setting['rtwcpiglw_watermark_text']); } ?>
		</textarea>
...
<tr>
	...
	<td>
		<select>
			...
			{
				?>
				<option><?php echo esc_html($rtwcpiglw_key);?></option>
				<?php
			}
			?>
		</select>
...
<tr>
	...
	<td class="descr_2">
		<input type="checkbox" id="rtwwpcfp_wtrmrk"
		name="rtwcpiglw_pckngslp_watermark_setting_opt[rtwcpiglw_enable_image_watermark]" value='1'
		<?php if(isset( $rtwcpiglw_get_setting['rtwcpiglw_enable_image_watermark']) && $rtwcpiglw_get_setting['rtwcpiglw_enable_image_watermark']=='1' ){echo 'checked=checked';} ?> />
...
<tr>
	...
	<td>
		...
		<div id="rtwcpiglw_wtrmrk_img" >
			...
			name="rtwcpiglw_pckngslp_watermark_setting_opt[rtwcpiglw_watermark_img_url]"
