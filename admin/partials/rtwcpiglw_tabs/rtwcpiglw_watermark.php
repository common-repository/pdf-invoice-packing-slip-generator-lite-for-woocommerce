...
<table class="wp-list-table form-table rtw-table">
	<tr>
		...
		<td class="descr_2">
			...
			name="rtwcpiglw_watermark_setting_opt[rtwcpiglw_enable_text_watermark]" value="1" <?php if(isset($rtwcpiglw_get_setting['rtwcpiglw_enable_text_watermark']) && $rtwcpiglw_get_setting['rtwcpiglw_enable_text_watermark']=="1"){ echo 'checked=checked';} ?>
			 />
...
<tr>
	...
	<td class="descr_2">
		<input type="checkbox" id="rtwwpcfp_wtrmrk"
		name="rtwcpiglw_watermark_setting_opt[rtwcpiglw_enable_image_watermark]" value='1'<?php if(isset($rtwcpiglw_get_setting['rtwcpiglw_enable_image_watermark']) && $rtwcpiglw_get_setting['rtwcpiglw_enable_image_watermark']=="1"){ echo 'checked=checked';} ?>
		 />
