...
if(isset(($_POST['rtwcpiglw_submit']))) 
{
	...
	<div class="notice notice-success is-dismissible">
		...
		update_option( 'rtwcpiglw_css_setting_opt', sanitize_post($_POST['rtwcpiglw_css_setting_opt']) );
	}
	settings_fields('rtwcpiglw_css_setting');
	$rtwcpiglw_get_setting = get_option('rtwcpiglw_css_setting_opt');
	...
	<table class="wp-list-table form-table rtw-table">
		<tbody>
			<tr>
				...
				<td class="descr_2">
					<select name="rtwcpiglw_css_setting_opt[rtwcpiglw_page_orien]">
						<option value="P" <?php echo isset( $rtwcpiglw_get_setting['rtwcpiglw_page_orien'] ) && $rtwcpiglw_get_setting['rtwcpiglw_page_orien'] == 'protctn_type_ordr_id' ? esc_html('selected="selected"') : '';?>><?php esc_html_e('Portrait', 'rtwcpiglw-pdf-invoice-generator-lite-for-woocommerce');?>
					</option>
					<option value="L" <?php echo isset( $rtwcpiglw_get_setting['rtwcpiglw_page_orien'] ) && $rtwcpiglw_get_setting['rtwcpiglw_page_orien'] == 'L' ? esc_html('selected="selected"') : '';?>><?php esc_html_e('Landscape', 'rtwcpiglw-pdf-invoice-generator-lite-for-woocommerce');?>
				</option>
			</select>
	...
	<tr>
		...
		<td class="descr_2">
			<select name="rtwcpiglw_css_setting_opt[rtwcpiglw_pdf_page_size]">
	...
	<tr>
		...
		<td class="descr_2">
			<input type="number" name="rtwcpiglw_css_setting_opt[rtwcpiglw_body_top_margin]" value="<?php echo esc_attr( isset ( $rtwcpiglw_get_setting['rtwcpiglw_body_top_margin'] ) ? $rtwcpiglw_get_setting['rtwcpiglw_body_top_margin'] : ''); ?>">
	...
	<tr>
		...
		<td class="descr_2">
			<input type="number" name="rtwcpiglw_css_setting_opt[rtwcpiglw_body_left_margin]" value="<?php echo esc_attr( isset ( $rtwcpiglw_get_setting['rtwcpiglw_body_left_margin'] ) ? $rtwcpiglw_get_setting['rtwcpiglw_body_left_margin'] : ''); ?>">
	...
	<tr>
		...
		<td class="descr_2">
			<input type="number" name="rtwcpiglw_css_setting_opt[rtwcpiglw_body_right_margin]" value="<?php echo esc_attr( isset ( $rtwcpiglw_get_setting['rtwcpiglw_body_right_margin'] ) ? $rtwcpiglw_get_setting['rtwcpiglw_body_right_margin'] : ''); ?>">
	...
	<tr>
		...
		<td class="descr_2">
			<input type="number" name="rtwcpiglw_css_setting_opt[rtwcpiglw_body_font_size]" value="<?php echo esc_attr( isset ( $rtwcpiglw_get_setting['rtwcpiglw_body_font_size'] ) ? $rtwcpiglw_get_setting['rtwcpiglw_body_font_size'] : ''); ?>">
	...
	<tr>
		...
		<td class="descr">
			<textarea rows="8" cols="50"><?php echo esc_html(isset( $rtwwpcf_get_setting['rtwcpiglw_pdf_css'] )) ? $rtwwpcf_get_setting['rtwcpiglw_pdf_css'] : ''; ?></textarea>
	...
	<tr>
		...
		<td class="descr_2">
			<select name="rtwcpiglw_css_setting_opt[rtwcpiglw_body_font_family]">
				<?php 
				foreach ( $rtwcpiglw_font_array as $rtwcpiglw_key => $rtwcpiglw_value ) 
				{ 
					?>
					<option value="<?php echo esc_attr($rtwcpiglw_value);?>" <?php echo esc_html(isset( $rtwcpiglw_get_setting['rtwcpiglw_body_font_family'] )) && $rtwcpiglw_get_setting['rtwcpiglw_body_font_family'] == $rtwcpiglw_value ? 'selected="selected"' : '';?>><?php echo esc_html($rtwcpiglw_key);?></option>
					<?php
				}
				?>
			</select>
